...
module.exports = [{
    id: 'civil_status', label: t({comment: 'civil_status', default: 'État civil'}), types: [
    ...
    id: 'mensurations', label: t({comment: 'mensurations', default: 'Mensurations'}), types: [
    ...
    id: 'ID', label: t({comment: 'ID', default: 'Identifiants'}), types: [
    ...
    id: 'online_ID', label: t({comment: 'online_ID', default: 'Identifiants en ligne'}), types: [
    ...
    id: 'contact_information', label: t({comment: 'contact_information', default: 'Coordonnées'}), types: [
    ...
    id: 'usage_history', label: t({comment: 'usage_history', default: 'Historique d\'usage'}), types: [
    ...
    id: 'business', label: t({comment: 'business', default: 'Informations professionnelles'}), types: [
    ...
    id: 'interest', label: t({comment: 'interest', default: 'Centres d\'intérêts'}), types: [
    ...
    id: 'image', label: t({comment: 'image', default: 'Image'}), types: [
